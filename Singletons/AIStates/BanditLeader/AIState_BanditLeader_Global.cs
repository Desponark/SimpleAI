...
public class AIState_BanditLeader_Global : State<Cognition> {
	private static readonly Lazy<AIState_BanditLeader_Global> lazy = new(() => new AIState_BanditLeader_Global());
	public static AIState_BanditLeader_Global Instance { get { return lazy.Value; } }
